...
namespace TestExercise.Controllers
{
    public class EventModelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,StartDate,EventLocation,ExtraInfo")] EventModel eventModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,StartDate,EventLocation,ExtraInfo")] EventModel eventModel)
        {
            if (id != eventModel.Id)
            {
                return NotFound();
